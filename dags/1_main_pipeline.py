...
from ingestion_covid import extract_covid_data  # Solo importamos extract_covid_data
...
dag = DAG(
    ...
    description="Pipeline unificado para COVID, Countries y Weather",
...
# Eliminamos validate_covid_task porque no existe validate_covid_data
